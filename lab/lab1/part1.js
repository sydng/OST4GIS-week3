...
var over9000 = function(x) {if (x > 9000) {
...
var valueAtKey = function(object) { for (var value in object) {
  return(object[value]); }
};
...
var countItem = function(arr, x) { for (i = 0; i < arr.length; i++) {
  if (arr[i] === x) {
    storeItem = storeItem + 1; } else { }
  }
  return storeItem;
};
